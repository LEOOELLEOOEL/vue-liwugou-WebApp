<template>
  <div class="content" ref="content">
    <div id="lazyDiv">
      <div class="subject">
        <img src="http://opc4ef7kt.bkt.clouddn.com/biilboard/original/original.png-optimize">
      </div>
      <div class="items">
        <div class="item" @click="showPresentDetail(item)" v-for="(item,index) in originalData">
          <div class="image">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    created() {
      this.$http.get('http://www.leoel.top/api/billboard_original.php').then((response) => {
